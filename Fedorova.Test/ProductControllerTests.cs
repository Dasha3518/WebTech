...
using Fedorova.UI.Controllers;
using Fedorova.UI.Services;
...
namespace Fedorova.Tests
{
    public class ProductControllerTests
    {
        ...
        public async void IndexSetsCorrectCurrentCategory()
        {
            ...
            var controller = new ProductController(_categoryService, _productService);
            //act
            var response = await controller.Index(currentCategory.Category.NormalizedName);
            //assert
            var view = Assert.IsType<ViewResult>(response);
